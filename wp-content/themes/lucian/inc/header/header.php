...
<?php endif;?>
<div id="zo-header" class="zo-main-header header-default <?php if ( !$smof_data['menu_sticky'] && empty($zo_meta->_zo_enable_header_fixed) ) {
    echo 'no-sticky';
    ...
    <div class="container-fluid">
        <div class="row">
            <div id="zo-header-logo" class="col-xs-12 col-sm-3 [ text-center ]">
            ...
            <div id="zo-header-navigation" class="col-xs-12 col-sm-9 [ menu-price-point ]">
            <?php else : ?>
            <div id="zo-header-navigation" class="col-xs-12 col-sm-9 [ menu-price-point ]">
            <?php endif; ?>
